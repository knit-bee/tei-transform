...
class WrongListChildObserverTester(unittest.TestCase):
    ...
    def test_observer_recognises_matching_elements(self):
        elements = [
            ...
            etree.XML("<p><list><list/></list></p>"),
            etree.XML("<p><list><item/><list/></list></p>"),
            etree.XML(
                "<TEI xmlns='a'><div><list><p/><list/><list><list/></list></list></div></TEI>"
            ),
            etree.XML("<TEI xmlns='a'><list><item/><list/><p/></list></TEI>"),
            etree.XML(
            ...
            etree.XML("<div><list><item/><table/></list></div>"),
            etree.XML("<p><list><table><row><cell/></row></table></list></p>"),
            etree.XML(
                "<TEI xmlns='a'><div><p/><list><item/><table><row/></table></list></div></TEI>"
            ),
        ]
    ...
    def test_observer_ignores_non_matching_elements(self):
        elements = [
            ...
            etree.XML("<p><list><item><list/></item></list></p>"),
            etree.XML("<div><list><item><p/></item></list><list/></div>"),
            ...
            etree.XML("<p><list><item><table/></item></list></p>"),
            etree.XML("<div><list/><table><list/></table></div>"),
            etree.XML(
                "<TEI xmlns='a'><div><list><item><table/></item></list></div></TEI>"
            ),
        ]
        for element in elements:
            result = {self.observer.observe(node) for node in element.iter()}
